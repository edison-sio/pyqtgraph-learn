...
class updateQTTargetThread3D(QThread):
    ...
    def __init__(self, pointCloud, targets, indexes, scatter, pcplot, numTargets, ellipsoids, coords, classifierOut=[], zRange=6, gw=[], colorByIndex=False, drawTracks=True, bbox=[0,0,0,0,0,0], bbox_en=0):
        QThread.__init__(self)
        self.pointCloud = pointCloud
        self.targets = targets
        self.indexes = indexes
